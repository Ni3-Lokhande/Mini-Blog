...
//     // In a real-world app, you'd upload the file to Firebase Storage and get the URL here
//   };
...
//       await addDoc(collection(fireDb, "blogPost"), {  // Ensure the collection name matches
//         title,
//         category,
//         content,
