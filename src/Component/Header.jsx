      ...
      <Navbar {...args} color='dark' dark expand='md' fixed='top'>
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="me-auto" navbar>
            <NavItem>
              <NavLink tag={ReactLink} to="/" onClick={closeNavbar}>Home</NavLink>
            </NavItem>
            <NavItem>
              <NavLink tag={ReactLink} to="/allblogs" onClick={closeNavbar}>Blogs</NavLink>
            </NavItem>
          </Nav>
          <NavbarText className="d-flex align-items-center">
            <NavLink tag={ReactLink} to="/login" onClick={closeNavbar} style={{ marginRight: '15px' }}>Admin Login</NavLink>
